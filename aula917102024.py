...
#####
#colocar o conceito de listas e tuplas 
...
# def ler_par():
#     try:
#         num1, num2 = map(int, input("Digite dois números inteiros (separados por espaço): ").split())
        
#         if num1 % 2 != 0:
#             raise NumeroImparException(f"O número {num1} é ímpar, somente números pares são permitidos.")
#         if num2 % 2 != 0:
#             raise NumeroImparException(f"O número {num2} é ímpar, somente números pares são permitidos.")
        
#         return (num1, num2)
    
#     except ValueError:
#         print("Entrada inválida. Certifique-se de inserir dois números inteiros.")
#     except NumeroImparException as e:
#         print(e)
#     finally:
#         print("Tentativa de leitura de par concluída.")
    
#     return ler_par()  # Repete a chamada até que uma entrada válida seja recebida.


# Função principal para ler três pares, calcular a soma e mostrar resultados
# def ler_tres_pares():
#     pares = [ler_par() for _ in range(3)]  # Lista de três pares lidos
    
#     for i, (num1, num2) in enumerate(pares, 1):
#         print(f"Soma do par {i}: {num1} + {num2} = {num1 + num2}")

# Executar o programa
# print(ler_tres_pares())
